...
<link href="{{asset('components/datetimepicker/css/bootstrap-datetimepicker.css')}}" rel="stylesheet" type="text/css" />
<link href="{{asset('components/datetimepicker/css/pmd-datetimepicker.css')}}" rel="stylesheet" type="text/css" />

<!-- /build -->

<!-- Propeller theme css-->
<link href="{{asset('css/propeller-theme.css')}}" rel="stylesheet" type="text/css" />


<!-- Propeller admin theme css-->
<link href="{{asset('css/propeller-admin.css')}}" rel="stylesheet" type="text/css" />
